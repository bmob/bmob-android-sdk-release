...
import com.example.bmobexample.file.Movie;
...
public class QueryActivity extends BaseActivity {
	...
	public void queryOne(){
		...
		query.getObject(this, "5f1042e183", new GetListener<Movie>() {
			
			@Override
			public void onSuccess(Movie object) {
				Log.i("life", ""+object.getFile().getFileUrl(QueryActivity.this));
			}
